module.exports = (m) => {
   ...
   if (setting) {
      ...
      global.db.setting = {
         ...
         online: true,
         onlyprefix: '+',
         owners: ['6283129196077'],
         lastReset: new Date * 1,
         msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://api.neoxr.my.id\n◦ *Source* : https://github.com/lutzcodez/lutz-bot\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         menuStyle: 4,
         cover: 'https://srv.neoxr.tk/files/Ff86r7.jpg',
         link: 'https://chat.whatsapp.com/BjigXj7GHH9CRIhUquTMwH'
      }
   }
}